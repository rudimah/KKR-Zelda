...
public class ConstantesTuile {
    ...
    public static final int BUISSON = 3;
    public static final int COFFRE = 4;
    public static final int PETIT_ROCHER = 5;
    public static final int POUBELLE = 6;
    public static final int ROCHER_EN_LAVE = 7;
    public static final int VOITURE_ABANDONNEE = 8;
    public static final int HERBE = 9;
    public static final int LAVE = 10;
